...
- Give your zap a name, example: "Automatic deploy superpotent" and make sure your zap is turned on
...
- Now go to the [form settings](https://app.netlify.com/sites/superpotent/settings/forms#outgoing-notifications) in you Netlify project
